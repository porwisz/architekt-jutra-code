...
export default class TypeBuilder {
    ...
    DimensionAssessment: ClassViewer<'DimensionAssessment', "verdict" | "score" | "explanation">;
    
    ProductAnalysis: ClassViewer<'ProductAnalysis', "overallVerdict" | "descriptionQuality" | "categoryRelevance" | "priceAssessment" | "summary">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "DimensionAssessment","ProductAnalysis",
          ]),
          enums: new Set([
        ...
        this.DimensionAssessment = this.tb.classViewer("DimensionAssessment", [
          "verdict","score","explanation",
        ]);
        
        this.ProductAnalysis = this.tb.classViewer("ProductAnalysis", [
          "overallVerdict","descriptionQuality","categoryRelevance","priceAssessment","summary",
        ]);
