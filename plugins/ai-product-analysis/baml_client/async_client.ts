...
import type {DimensionAssessment, ProductAnalysis} from "./types"
...
export type RecursivePartialNull<T> = MovedRecursivePartialNull<T>
    ...
    env?: Record<string, string | undefined>
      tags?: Record<string, string>
        ...
        productName: string,productDescription: string,categoryName: string,price: string,
        __baml_options__?: BamlCallOptions<never>
        ): Promise<types.ProductAnalysis> {
          try {
          ...
          const __stream__ = this.stream.AnalyzeProduct(
          productName,productDescription,categoryName,price,
          __baml_options__
          );
          ...
          const __env__: Record<string, string> = Object.fromEntries(
            ...
            "AnalyzeProduct",
            {
            "productName": productName,"productDescription": productDescription,"categoryName": categoryName,"price": price
            },
            ...
            return __raw__.parsed(false) as types.ProductAnalysis
            } catch (error) {
            ...
            productName: string,productDescription: string,categoryName: string,price: string,
            __baml_options__?: BamlCallOptions<never>
            ): BamlStream<partial_types.ProductAnalysis, types.ProductAnalysis>
              {
              try {
              const __options__ = { ...this.bamlOptions, ...(__baml_options__ || {}) }
              const __signal__ = __options__.signal;
              ...
              console.error("Error in onTick callback for AnalyzeProduct", error);
              }
              }
              };
              }
              ...
              const __env__: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ProductAnalysis, types.ProductAnalysis>(
                  __raw__,
                  (a): partial_types.ProductAnalysis => a,
                  (a): types.ProductAnalysis => a,
                  this.ctxManager.cloneContext(),
                  __options__.signal,
                  )
                  } catch (error) {
